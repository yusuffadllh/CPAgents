...
// Normalize a stored model name. Settings rows sometimes hold names with a
// leading slash (e.g. "/grok-4.5") or stray whitespace; sending those literal
// strings to the gateway returns 404 model_not_found. Trim + strip leading
// slashes everywhere a model name leaves the Settings table.
export function normalizeModelName(name, fallback = 'google/gemini-2.5-pro') {
